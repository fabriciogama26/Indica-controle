...
- [x] Incluir `Grupo *` e `Alcance` no cadastro/edicao de `Atividades`, exigindo `Grupo` no frontend, API e RPC transacional (migration `180_require_service_activity_group_in_rpc.sql`).
