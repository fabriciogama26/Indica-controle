- [x] [Docs] Mapear exportacao Excel/CSV e paginacao de listas em todas as telas: `docs/Exportacao_SaaS.txt` e `docs/Listas_Paginacao_SaaS.txt` criados com inventario completo por tela, duplicacoes de codigo identificadas e analise de viabilidade de util generico de paginacao (nenhum codigo alterado, apenas levantamento e documentacao).
