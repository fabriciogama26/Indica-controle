...
- [ ] [P2][Duplicacao] Criar src/lib/utils/formatters.ts e parsers.ts e migrar copias confirmadas (formatDateTime, formatAuditActor, parseCsvLine duplicados em multiplos PageViews).
- [ ] [P2][Duplicacao] Reduzir duplicacoes em API routes: boilerplate de auth/tenant, normalizadores, paginacao e tratamento de erro repetidos em activities, stock-transfers, faturamento, people, teams e outros.
...
- [ ] [P2][Programacao] Continuar modularizacao interna de programacao/ProgrammingPageView.tsx: extrair hooks de estado/dados e componentes de UI.
