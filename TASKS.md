...
- [x] [P1][Operacoes de Equipe][Estorno em lote] Ao selecionar uma linha, abrir modal agrupado pelo `transferId` da requisicao, listar todos os materiais e seus status de estorno e permitir estornar atomicamente todos os itens ainda ativos, preservando o estorno individual, o escopo por tenant, a auditoria, a validacao de saldo/serial e a protecao contra concorrencia; implementado pela migration `236_add_team_stock_operation_batch_reversal.sql`, API autorizada e documentacao da tela.
