...
- [x] [Performance] Adicionar validacao de janela maxima de 60 dias no `GET /api/programacao`, retornando 400 com mensagem clara quando `endDate - startDate > 60 dias` (src/app/api/programacao/route.ts)
