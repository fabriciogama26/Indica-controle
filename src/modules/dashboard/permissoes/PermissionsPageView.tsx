...
const permissionCatalog = [
  ...
  { pageKey: "dashboard-carteira-operacional", label: "Dashboard Carteira Operacional", path: "/dashboard-carteira-operacional", section: "Visao Geral" },
  ...
  { pageKey: "estoque-equipes", label: "Estoque das Equipes", path: "/estoque-equipes", section: "Almoxarifado" },
  { pageKey: "mapa-almoxarifado", label: "Mapa do Almoxarifado", path: "/mapa-almoxarifado", section: "Almoxarifado" },
  ...
  {
    pageKey: "configuracao-mapa-almoxarifado",
    label: "Configuracao do Mapa do Almoxarifado",
    path: "/configuracao-mapa-almoxarifado",
  ...
  { pageKey: "tipo-atividade", label: "Tipo de Atividade", path: "/tipo-atividade", section: "Cadastro Base" },
