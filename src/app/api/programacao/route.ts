    ...
    const boardPayload = {
      ...
      schedules: filteredProgrammingRows.map((item) => {
        ...
        return {
          ...
          anticipatedByProgrammingId: normalizeText(item.anticipated_by_programming_id),
          anticipatedAt: normalizeText(item.anticipated_at),
          previousWorkCompletionStatus: normalizeWorkCompletionStatus(item.previous_work_completion_status),
