-- 117_allow_measurement_context_edit_and_history_details.sql
-- Permite editar contexto da medicao (Projeto, Equipe e Data execucao)
-- mantendo save + historico no mesmo RPC transacional.
