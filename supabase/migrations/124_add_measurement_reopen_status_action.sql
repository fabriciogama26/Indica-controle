-- 124_add_measurement_reopen_status_action.sql
-- Permite reabrir ordem FECHADA via acao ABRIR com motivo obrigatorio.
-- Mantem fluxo transacional e registro de historico no mesmo RPC.
