...
-- Garante que Operacoes de Equipe chamem explicitamente a assinatura atual de
-- save_stock_transfer_record apos a inclusao de operation_purpose na migration 206.
