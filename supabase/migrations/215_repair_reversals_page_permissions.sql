...
-- Repara ambientes onde a tela Estornos foi publicada sem o catalogo de permissoes.
...
values
  (
    ...
    'Estornos',
    'Almoxarifado',
    'Consulta centralizada dos estornos de Movimentacao de Estoque e Operacoes de Equipe.'
  )
...
select
  ...
  tu.user_id,
  tp.page_key,
  coalesce(rpp.can_access, true) as can_access,
  null,
  null
