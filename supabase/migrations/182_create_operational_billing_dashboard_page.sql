...
-- Cadastra a tela Dash operacional e faturamento na matriz de paginas e permissoes.
...
values
  (
    ...
    '/dash-operacional-faturamento',
    'Dash operacional e faturamento',
    'Visao Geral',
    'Comparativo de codigos entre Medicao, Medicao Asbuilt e Faturamento por projeto.'
  )
...
join public.app_pages as pages
  on pages.ativo = true
 and pages.page_key = 'dash-operacional-faturamento'
...
with target_pages as (
  ...
  where ativo = true
    and page_key = 'dash-operacional-faturamento'
),
target_users as (
  select
    au.id as user_id,
