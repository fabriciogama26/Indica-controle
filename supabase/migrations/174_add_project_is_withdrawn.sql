...
-- Adiciona marcador de retirada da carteira em projetos, atualiza view de labels e RPC de escrita.
...
create index if not exists idx_project_tenant_is_withdrawn
  on public.project (tenant_id, is_withdrawn);
