...
-- Garante que Operacoes de Equipe chamem a assinatura atual de save_stock_transfer_record
-- apos a inclusao de p_direct_purchase em 193_allow_direct_purchase_stock_entry.sql.
