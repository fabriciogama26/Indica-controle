...
-- Cadastra o Dashboard Equipes e preenche somente permissoes ausentes.
...
values (
  ...
  'Dashboard Equipes',
  'Visao Geral',
  'Indicadores de desempenho por MK, encarregado e supervisor.'
)
...
left join public.role_page_permissions existing
 ...
 and existing.page_key = 'dashboard-equipes'
...
left join public.role_page_permissions role_permissions
 ...
 and role_permissions.page_key = 'dashboard-equipes'
