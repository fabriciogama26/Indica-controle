...
- Nova constraint `team_compositions_team_single_foreman_per_date` (EXCLUDE via btree_gist): a mesma equipe nao pode ter, na mesma data, duas composicoes ativas com encarregados diferentes. Sem ela a resolucao teria duas respostas possiveis e o `limit 1` do nivel 1 escolheria arbitrariamente. Complementa a constraint da 373, que fecha o sentido inverso.
