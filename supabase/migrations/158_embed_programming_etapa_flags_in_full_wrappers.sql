-- 158_embed_programming_etapa_flags_in_full_wrappers.sql
-- Embute persistencia de etapa_unica/etapa_final nas RPCs full de Programacao
-- para evitar etapa complementar fora da transacao principal no backend da API.
