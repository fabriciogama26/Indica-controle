...
-- Cadastra a tela Dashboard Estoque na matriz de paginas e permissoes.
...
values
  (
    ...
    'Dashboard Estoque',
    'Visao Geral',
    'Indicadores de saldo, giro, criticidade e operacoes de estoque.'
  )
...
join public.app_pages as pages
  on pages.ativo = true
 and pages.page_key = 'dash-estoque'
