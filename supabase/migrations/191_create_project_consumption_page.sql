...
-- Cadastra a tela Consumo por Projeto na matriz de paginas e permissoes.
...
values
  (
    ...
    'Consumo por Projeto',
    'Almoxarifado',
    'Comparativo entre materiais previstos, requisitados e devolvidos por projeto.'
  )
...
join public.app_pages as pages
  on pages.ativo = true
 and pages.page_key = 'consumo-projeto'
