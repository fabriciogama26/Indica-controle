...
-- Inclui a tela de visualizacao da Programacao em app_pages e faz backfill de permissoes por tenant.
...
values
  (
    ...
    'Operacao',
    'Lista filtrada e calendario semanal da programacao por equipe.'
  )
...
join public.app_pages as pages
  on pages.ativo = true
 and pages.page_key = 'programacao-visualizacao'
...
with target_pages as (
  ...
  where ativo = true
    and page_key = 'programacao-visualizacao'
),
target_users as (
  select
    au.id as user_id,
