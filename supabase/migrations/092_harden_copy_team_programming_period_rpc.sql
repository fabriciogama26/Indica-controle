-- 092_harden_copy_team_programming_period_rpc.sql
-- Endurece a copia da linha da equipe no periodo visivel para copiar apenas atividades ativas e todos os campos da Programacao via RPC full.
