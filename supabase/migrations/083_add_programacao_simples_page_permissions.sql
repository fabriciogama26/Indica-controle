...
-- Inclui a nova Programacao em app_pages e faz backfill de permissoes por tenant.
...
values
  (
    ...
    'Programacao',
    'Operacao',
    'Cadastro de programacao com selecao de multiplas equipes.'
  )
...
join public.app_pages as pages
  on pages.ativo = true
 and pages.page_key = 'programacao-simples'
...
with target_pages as (
  ...
  where ativo = true
    and page_key = 'programacao-simples'
),
target_users as (
  select
    au.id as user_id,
