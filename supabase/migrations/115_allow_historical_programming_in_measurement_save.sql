-- 115_allow_historical_programming_in_measurement_save.sql
-- Permite gerar Ordem de Medicao para Programacoes historicas (qualquer status),
-- mantendo o mesmo RPC transacional de save + historico.
