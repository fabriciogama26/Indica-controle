-- 103_harden_postpone_patch_error_reporting.sql
-- Endurece o retorno da RPC de adiamento para expor detalhe real da falha e suportar PATCH com pos-save resiliente.
