...
--   scripts/performance/supabase-log-explorer-monitoring.txt
--
-- Como usar:
-- 1. Abra Supabase Dashboard > Logs > Logs Explorer.
-- 2. Abra scripts/performance/supabase-log-explorer-monitoring.txt.
-- 3. Copie e rode um bloco por vez no Logs Explorer.

select
  'Use scripts/performance/supabase-monitoring-readonly.sql no SQL Editor/Postgres.' as sql_editor,
  'Use scripts/performance/supabase-log-explorer-monitoring.txt no Supabase Logs Explorer.' as logs_explorer;
