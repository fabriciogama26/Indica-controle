...
$knownNoRevoke = @{
    ...
    259 = "Corrigida pelas migrations 278/285/298 (save) e 388 (status/batch)"
    260 = "Corrigida pelas migrations 278/298 (save) e 388 (batch)"
    261 = "Corrigida pelas migrations 278/298 (save) e 388 (batch)"
    262 = "Corrigida pelas migrations 278/298 (save) e 388 (batch)"
