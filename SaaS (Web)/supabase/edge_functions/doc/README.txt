...
- supabase/edge_functions/auth-login-web/index.ts
...
Resumo
login_matricula
- Login por matricula, senha e IMEI para o app Android.

auth-login-web
- Login por login_name e senha para o SaaS web.
...
log_error
- Grava erros do app/site em app_error_logs.
...
Observacao
- O app Android esta coberto pelas functions atuais.
- O SaaS web inicial depende de `auth-login-web`, `logout` e `log_error`.
