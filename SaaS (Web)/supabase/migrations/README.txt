...
- Adiciona login_name em app_users, login_audit e app_error_logs para suportar o login web.

Lacunas ainda nao versionadas
- modelagem final de projects
- auth_session_activity e fluxo completo de sessao web por inatividade

Observacao
- As migrations acima suportam o app atual e a base inicial do SaaS web.
