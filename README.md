...
- `src/modules/dashboard/medicao-asbuilt/`
  - `AsbuiltMeasurementPageView.tsx`: tela Medicao Asbuilt com cadastro manual, cadastro em massa, filtros, lista, detalhe, historico, status e bloqueio de projeto inativo.
