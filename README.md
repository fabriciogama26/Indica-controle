...
- `Estado Trabalho ANTECIPADA nao esta ativo no catalogo do tenant atual`:
  - Causa: o usuario salvou uma etapa como `CONCLUIDO`, mas o catalogo do tenant ainda nao possui o codigo `ANTECIPADA` exigido para atualizar etapas posteriores.
