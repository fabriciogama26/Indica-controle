...
- `src/app/`
  ...
  - `(dashboard)/programacao/page.tsx`: rota da tela de Programacao com painel de pendencias, grade semanal/diaria de equipes, status de locacao no card do projeto, drag and drop, adiamento/cancelamento com motivo e persistencia real via API.
  ...
  - `api/programacao/route.ts`: lista projetos/equipes/programacoes do periodo, salva a agenda real da tela de Programacao e altera status de programacoes com motivo, historico e controle de concorrencia.
...
- `src/modules/dashboard/programacao/`
  - `ProgrammingPageView.tsx`: tela de programacao com painel de projetos pendentes, indicador de locacao no card da obra, timeline por equipe, cards agendados, drag and drop, adiamento/cancelamento por motivo, base real da equipe e integracao autenticada com `/api/programacao`.
