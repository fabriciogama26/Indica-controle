...
- `src/app/`
  ...
  - `(dashboard)/composicao-equipe/page.tsx`: rota da Composicao de Equipe com painel diario de equipes pendentes/concluidas, registro por projeto/equipe, situacao `Atuando` ou `Nao atuou`, integrantes, presenca, detalhes, historico e CSV.
