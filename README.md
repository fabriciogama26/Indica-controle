...
38. A rota `/dashboard-carteira-operacional` analisa projetos com atividades previstas cadastradas em Projetos, exclui teste/terceiros/inativos, calcula o valor previsto no backend por `Pontos x Quantidade prevista x Valor unitario x taxa(1)`, permite filtrar carteira ativa/retirada/ambas e todos os ciclos, trata estados parciais como pendentes, separando saude por quantidade, financeiro da carteira, fluxo, renovacao, envelhecimento, potencial por supervisor, diagnostico automatico e tabela analitica com dias parado/ciclos sem producao.
