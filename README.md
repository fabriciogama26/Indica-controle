...
- `src/app/`
  ...
  - `api/warehouse-addressing/config/route.ts`: carrega centros de estoque e configuracao do mapa do almoxarifado; salva layout por RPC transacional com permissao `configuracao-mapa-almoxarifado/update`.
  - `api/warehouse-addressing/map/route.ts`: carrega mapa, saldo e enderecos por centro; atribui/remove endereco por RPC com permissao `mapa-almoxarifado/update`.
